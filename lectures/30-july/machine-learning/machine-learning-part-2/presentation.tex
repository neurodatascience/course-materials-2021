...
\maketitle
\section{Intro}
\label{sec:org874f5d8}
\subsection{Recap of part 1}
\label{sec:org9ab7a94}
\begin{frame}[label={sec:org70ead5b}]{Recap of part 1}
...
\end{structureenv}
\end{frame}
\begin{frame}[label={sec:orgea9fbea}]{Notation \& vocabulary}
...
\end{frame}
\begin{frame}[label={sec:orgf36639b}]{Model complexity: overfitting}
\begin{itemize}
...
\begin{frame}[label={sec:org8479c9e}]{Univariate feature selection}
...
\begin{frame}[label={sec:org8b0004b}]{Same plot in log scale}
\begin{center}
...
\label{sec:orgd74c3f9}
\begin{frame}[label={sec:org47c3d06}]{Linear decomposition methods}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgee77ef6}]{Linear regression: projection on the column space of \(X\)}
...
\end{structureenv}
\end{frame}
\begin{frame}[label={sec:org6833ec1}]{Linear decomposition: low-rank approximation of \(\X\)}
Minimize
\begin{equation}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org1c99127}]{Linear regression after dimensionality reduction}
\begin{equation}
\hat{\y} = \W \, \hat{\bbeta}
\end{equation}
\begin{center}
