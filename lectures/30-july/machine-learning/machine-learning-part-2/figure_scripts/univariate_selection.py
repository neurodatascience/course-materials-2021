...
x1, x2, y = rng.multivariate_normal(
    [0, 0, 0], [[1., 0, .8], [0, 1, 0], [.8, 0, 1.]], size=20
).T
...
fig, axes = plt.subplots(1, 2, figsize=figsize)
axes[0].scatter(x1[y == 0], y[y == 0])
axes[0].scatter(x1[y == 1], y[y == 1], marker="^")
axes[1].scatter(x2[y == 0], y[y == 0])
axes[1].scatter(x2[y == 1], y[y == 1], marker="^")
