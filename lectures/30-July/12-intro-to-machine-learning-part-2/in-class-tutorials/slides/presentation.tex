...
\maketitle
\begin{frame}[label={sec:org821eeaf}]{Problem setting}
\begin{equation}
Y = f(X) + E
\end{equation}
\vspace{-10pt}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org0a5dcbc},fragile]{Parameter estimation \aka model fitting}
 Minimize a sum of:
\begin{itemize}
...
\end{structureenv}
\end{frame}
\begin{frame}[label={sec:orgb44f270},fragile]{scikit-learn "estimator API": \texttt{fit; predict}}
 \begin{verbatim}
...
\begin{frame}[label={sec:org84b0ba8},fragile]{Example: \texttt{decomposition.PCA}}
 \begin{block}{\texttt{fit:}}
\begin{itemize}
\item Compute Singular Value Decomposition of \(\X\)
\end{itemize}
...
\begin{frame}[label={sec:org2c63a43},fragile]{Example: \texttt{decomposition.PCA}}
 \begin{block}{\texttt{fit:}}
\begin{itemize}
\item Compute Singular Value Decomposition of \(\X\)
\end{itemize}
...
\begin{frame}[label={sec:org44fe88e},fragile]{Example: \texttt{decomposition.PCA}}
 \begin{block}{\texttt{fit:}}
\begin{itemize}
\item Compute Singular Value Decomposition of \(\X\)
\end{itemize}
...
\end{structureenv}
\end{frame}
\begin{frame}[label={sec:orge020eed},fragile]{Chaining transformations}
...
\end{frame}
\begin{frame}[label={sec:orgec467c0},fragile]{Cross-validation and hyperparameter selection in scikit-learn}
 \begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org9e61e3c},fragile]{Cross-validation pitfalls}
 \begin{itemize}
